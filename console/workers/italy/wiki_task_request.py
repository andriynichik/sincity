...
options.update(url_format="https://it.wikipedia.org/w/index.php?search={0}&title=Sp%C3%A9cial:Recherche&limit=30&offset=0&profile=default&fulltext=1&searchengineselect=mediawiki&searchToken=ac9zaxa1lggzxpdhc5ukg06t6")
